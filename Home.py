...
st.header('นางสาวพรพรรณ บุญก่อสร้าง')
...
with col1:
    st.image('./pic/pro.jpg')
with col2:
    st.image('./pic/iris.jpg')

    html_1 = """
<div style="background-color:#66ccff;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black">
